...
class People {  			//Main class
	...
	public static void main(String args[]){			//main method
			...
			for(int i=0;i<n;i++){
					System.out.println("\nEnter the details of Teacher "+(i+1)); 		//enter the details of all data members using for loop
					System.out.println("------------------------------");
		...
		for(int j=0;j<n;j++){ 
				...
				arr[j].display();			 //calling display method of each teacher objects using for loop
